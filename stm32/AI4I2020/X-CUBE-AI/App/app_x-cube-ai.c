...
AI_ALIGNED(4) ai_i8 data_in_1[AI_AI4I_IN_1_SIZE_BYTES];
ai_i8* data_ins[AI_AI4I_IN_NUM] = {
data_in_1
};
#else
ai_i8* data_ins[AI_AI4I_IN_NUM] = {
...
AI_ALIGNED(4) ai_i8 data_out_1[AI_AI4I_OUT_1_SIZE_BYTES];
ai_i8* data_outs[AI_AI4I_OUT_NUM] = {
data_out_1
};
#else
ai_i8* data_outs[AI_AI4I_OUT_NUM] = {
...
AI_ALIGNED(32)
static uint8_t pool0[AI_AI4I_DATA_ACTIVATION_1_SIZE];

ai_handle data_activations0[] = {pool0};

/* AI objects ----------------------------------------------------------------*/

static ai_handle ai4i = AI_HANDLE_NULL;
