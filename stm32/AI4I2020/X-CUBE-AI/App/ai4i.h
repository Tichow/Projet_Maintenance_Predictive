...
#include "ai4i_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_AI4I_MODEL_NAME          "ai4i"
#define AI_AI4I_ORIGIN_MODEL_NAME   "modele_maintenance"

/******************************************************************************/
#define AI_AI4I_ACTIVATIONS_ALIGNMENT   (4)
#define AI_AI4I_INPUTS_IN_ACTIVATIONS   (4)
#define AI_AI4I_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_AI4I_IN_NUM        (1)

AI_DEPRECATED
#define AI_AI4I_IN \
  ai_ai4i_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AI4I_IN_SIZE { \
  AI_AI4I_IN_1_SIZE, \
}
#define AI_AI4I_IN_SIZE_BYTES { \
  AI_AI4I_IN_1_SIZE_BYTES, \
}
#define AI_AI4I_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_AI4I_IN_1_CHANNEL     (8)
#define AI_AI4I_IN_1_SIZE        (8)
#define AI_AI4I_IN_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_AI4I_OUT_NUM       (1)

AI_DEPRECATED
#define AI_AI4I_OUT \
  ai_ai4i_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AI4I_OUT_SIZE { \
  AI_AI4I_OUT_1_SIZE, \
}
#define AI_AI4I_OUT_SIZE_BYTES { \
  AI_AI4I_OUT_1_SIZE_BYTES, \
}
#define AI_AI4I_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_AI4I_OUT_1_CHANNEL     (5)
#define AI_AI4I_OUT_1_SIZE        (5)
#define AI_AI4I_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_AI4I_N_NODES (8)
 ...
 * @ref ai_ai4i_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_AI4I_*
 * defines into file @ref ai4i.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
