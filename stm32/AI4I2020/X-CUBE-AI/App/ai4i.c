...
#define AI_AI4I_MODEL_SIGNATURE     "0x22a3aca055ad4bab33a02af04a93fcbf"
...
#define AI_TOOLS_DATE_TIME   "2026-03-04T20:50:07+0100"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_1470_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Tensor #16 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_1470_output, AI_STATIC,
  16, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 1), AI_STRIDE_INIT(4, 4, 4, 32, 32),
  1, &serving_default_keras_tensor_1470_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_keras_tensor_1470_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 13076, 1, 1),
    13076, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 384, 1, 1),
    384, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_AI4I_IN_NUM, &serving_default_keras_tensor_1470_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_AI4I_OUT_NUM, &nl_4_output),
  &gemm_0_layer, 0x8b1d5b2c, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_ai4i_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_1470_output_array.data = AI_PTR(g_ai4i_activations_map[0] + 96);
    serving_default_keras_tensor_1470_output_array.data_start = AI_PTR(g_ai4i_activations_map[0] + 96);
    gemm_0_output_array.data = AI_PTR(g_ai4i_activations_map[0] + 128);
    gemm_0_output_array.data_start = AI_PTR(g_ai4i_activations_map[0] + 128);
    nl_0_nl_output_array.data = AI_PTR(g_ai4i_activations_map[0] + 128);
    nl_0_nl_output_array.data_start = AI_PTR(g_ai4i_activations_map[0] + 128);
    ...
    nl_1_nl_output_array.data = AI_PTR(g_ai4i_activations_map[0] + 128);
    nl_1_nl_output_array.data_start = AI_PTR(g_ai4i_activations_map[0] + 128);
    ...
    nl_2_nl_output_array.data = AI_PTR(g_ai4i_activations_map[0] + 64);
    nl_2_nl_output_array.data_start = AI_PTR(g_ai4i_activations_map[0] + 64);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_ai4i_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_ai4i_weights_map[0] + 2048);
    gemm_0_bias_array.data_start = AI_PTR(g_ai4i_weights_map[0] + 2048);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_ai4i_weights_map[0] + 2304);
    gemm_1_weights_array.data_start = AI_PTR(g_ai4i_weights_map[0] + 2304);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_ai4i_weights_map[0] + 10496);
    gemm_1_bias_array.data_start = AI_PTR(g_ai4i_weights_map[0] + 10496);
    gemm_2_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_weights_array.data = AI_PTR(g_ai4i_weights_map[0] + 10624);
    gemm_2_weights_array.data_start = AI_PTR(g_ai4i_weights_map[0] + 10624);
    gemm_2_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_2_bias_array.data = AI_PTR(g_ai4i_weights_map[0] + 12672);
    gemm_2_bias_array.data_start = AI_PTR(g_ai4i_weights_map[0] + 12672);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_ai4i_weights_map[0] + 12736);
    gemm_3_weights_array.data_start = AI_PTR(g_ai4i_weights_map[0] + 12736);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_ai4i_weights_map[0] + 13056);
    gemm_3_bias_array.data_start = AI_PTR(g_ai4i_weights_map[0] + 13056);
    return true;
  }
